"""
📋 Tabla de suscripciones — Resumen, Treeview y Footer
Componente que muestra la lista de suscripciones con el total mensual/anual.
"""
...
class Tabla(ttk.Frame):
    ...
    def refrescar(self):
        """Refresca la tabla con los datos actuales de suscripciones."""
        # Limpiar tabla
